...
export const orderApi = {
  ...
  previewCoupon: (data: Pick<CreateOrderRequest, "product_id" | "spec_id" | "quantity" | "coupon_code">) =>
    request<CouponPreviewResult>("/orders/preview-coupon", { method: "POST", body: JSON.stringify(data) }),
  previewCartCoupon: (data: Pick<CreateCartOrderRequest, "coupon_code">) =>
    request<CouponPreviewResult>("/orders/from-cart/preview-coupon", { method: "POST", body: JSON.stringify(data) }),
...
export const adminCouponApi = {
  getList: () =>
    request<AdminCouponItem[]>("/admin/coupons"),
  create: (data: {
    code: string
    name: string
    ...
    request<null>("/admin/coupons", { method: "POST", body: JSON.stringify(data) }),
  update: (id: string, data: Partial<{
    code: string
    name: string
    discount_type: CouponDiscountType
...
const ERROR_CODE_I18N: Record<number, string> = {
  ...
  40009: "error.couponInvalid",
  40010: "error.couponUnavailable",
  // Payment
