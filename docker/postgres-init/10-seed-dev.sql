...
SELECT gen_random_uuid(),
       ...
       '微信支付',
       'epay',
       '{"pid":"1000001","key":"demo-epay-key","api_url":"http://mock-epay:18080/","notify_url":"http://api:8083/api/payments/webhook/epay","return_url":"http://localhost:3000/order/query"}',
       true,
       1,
       0,
       NOW(),
